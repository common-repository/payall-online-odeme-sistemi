...
class PayallHelper {
	...
	public static function payall_Guid() {
	...
	public static function payall_get_client_ip() {
	 ...
	 */
	public static function payall_FormattoXMLOutput($input_xml) {
		$doc = new DOMDocument ();
	 ...
	 * @return string
	 */
	public static function payall_getCurrentUrl() {
